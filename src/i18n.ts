...
const EN: Dict = {
  ...
  'params.bridges': 'Bridges per island',
  'params.auto': 'auto',
  'params.cornerR': 'Corner rounding',
  ...
  'lighting.cafe': 'café (warm)',
  'lighting.dramatic': 'dramatic',
  'lighting.top': 'from above',
  'material.plaMatte': 'matte PLA',
  'material.plaGloss': 'glossy PLA',
  'material.silk': 'silk PLA',
  'material.petg': 'translucent PETG',
  'material.steel': 'stainless steel',
  'material.brass': 'brass',
  'material.copper': 'copper',
  'surface.smooth': 'smooth',
  'surface.printed': 'print lines',
  'surface.blasted': 'bead-blasted',
...
const CS: Dict = {
  ...
  'params.bridges': 'Můstky na ostrůvek',
  'params.auto': 'auto',
  'params.cornerR': 'Zaoblení rohů',
  ...
  'look.toggle': 'Režim prohlížení',
  'look.lighting': 'Nasvícení',
  'look.background': 'Pozadí',
  'look.material': 'Materiál',
  'look.color': 'Barva',
  'look.surface': 'Povrch',
  'lighting.studio': 'studio',
  'lighting.daylight': 'denní světlo',
  'lighting.cafe': 'kavárna (teplé)',
  'lighting.dramatic': 'dramatické',
  'lighting.top': 'shora',
  'material.plaMatte': 'PLA matné',
  'material.plaGloss': 'PLA lesklé',
  'material.silk': 'hedvábné PLA',
  'material.petg': 'PETG průsvitné',
  'material.steel': 'nerez',
  'material.brass': 'mosaz',
  'material.copper': 'měď',
  'surface.smooth': 'hladký',
  'surface.printed': 'tiskové vrstvy',
  'surface.blasted': 'pískovaný',
